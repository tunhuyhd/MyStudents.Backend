...
namespace MyStudents.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260523071547_AddPasswordResetToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStudents.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MyStudents.Domain.Entities.PasswordResetToken", b =>
                {
                    b.HasOne("MyStudents.Domain.Entities.User", "User")
                        .WithMany()
